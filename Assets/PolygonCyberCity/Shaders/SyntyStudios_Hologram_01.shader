	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord9.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
				
				float2 uv_EmissionMask2 = input.ase_texcoord9.xy;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord3.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord4.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
				
				float2 uv_EmissionMask2 = input.ase_texcoord4.xy;
				float4 tex2DNode2 = tex2D( _EmissionMask, uv_EmissionMask2 );
				float4 color10 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float4 lerpResult12 = lerp( (( _EmissionMask_FlatColourSwitch )?( (( _EmissionMask_TintSwitch )?( ( _Neon_Colour_01 * tex2DNode2 ) ):( tex2DNode2 )) ):( _Neon_Colour_01 )) , color10 , 0.3);
				float2 temp_cast_1 = (_Scroll_Speed).xx;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord2.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord5.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_AlbedoTexture16 = input.ase_texcoord.xy;
				float4 tex2DNode16 = tex2D( _AlbedoTexture, uv_AlbedoTexture16 );
				

				surfaceDescription.Alpha = ( tex2DNode16.a * _Opacity );
...
Node;AmplifyShaderEditor.SamplerNode;13;-1644.464,20.95347;Inherit;True;Property;_HoloLines;HoloLines;9;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;16;-925.6416,-390.5948;Inherit;True;Property;_AlbedoTexture;AlbedoTexture;2;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=8D6765352D1B6DF4929444FD9902C0C0C884ED7D